...
public interface IProxyConnectionListener extends IEventListener
{
     ...
     *
     * @param proxyId
     *            the name of the proxy that is now connected (IPlatformServiceProxy#getComponentName())
     */
     ...
     *
     * @param proxyId
     *            the name of the proxy that is not connected anymore (IPlatformServiceProxy#getComponentName())
     */
