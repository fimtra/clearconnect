...
public abstract class DataFissionProperties
{
    ...
    public interface Names
    {
        ...
        /**
         * The system property name to define the timeout in milliseconds to wait for the execution start of
         * an RPC.<br> E.g. <code>-DdataFission.rpcExecutionStartTimeoutMillis=5000</code>
         */
        String RPC_EXECUTION_START_TIMEOUT_MILLIS = BASE + "rpcExecutionStartTimeoutMillis";

        /**
         * The system property name to define the timeout in milliseconds to wait for the execution duration
         * of an RPC. The duration timeout begins <b>after</b> the RPC execution starts.
         * <br>
        ...
        /**
         * The system property name to define the period in milliseconds to wait before a {@link ProxyContext}
         * will attempt re-connecting to a {@link Context} after losing the connection.<br> E.g.
         * <code>-DdataFission.proxyReconnectPeriodMillis=1000</code>
         */
        String PROXY_CONTEXT_RECONNECT_PERIOD_MILLIS = BASE + "proxyReconnectPeriodMillis";

        /**
         * The system property name to define the maximum number of atomic changes per message sent from a
         * {@link Publisher}.<br> E.g. <code>-DdataFission.maxChangesPerMessage=20</code>
         */
        String PUBLISHER_MAXIMUM_CHANGES_PER_MESSAGE = BASE + "maxChangesPerMessage";

        /**
         * The system property name to define the period, in seconds, for logging the context core executors
         * statistics.
         * <p>
        ...
        /**
         * The system property name to define the maximum number of fields in a map to print.<br> E.g.
         * <code>-DdataFission.maxMapFieldsToPrint=30</code>
         */
        ...
        /**
         * The system property name to define the size of the {@link TextValue} pool.<br> E.g.
         * <code>-DdataFission.textValuePoolSize=2048</code>
         */
        String TEXT_VALUE_POOL_SIZE = BASE + "textValuePoolSize";

        /**
         * The system property name to define the length limit to be eligible for the value to be held in the
         ...
         * number of messages that a publisher will transmit that are changes to system records, which are
         * generally not processed at the same rate as application records.<br> E.g.
         * <code>-DdataFission.systemRecordCoalesceWindowMillis=250</code>
         */
        String SYSTEM_RECORD_COALESCE_WINDOW_MILLIS = BASE + "systemRecordCoalesceWindowMillis";

        /**
         * The number of deltas pending processing for a record before starting to log them. This helps to
         * reduce chatty logs when network problems interrupt delta sequences. <br> E.g.
         * <code>-DdataFission.deltaCountLogThreshold=6</code>
         */
        String DELTA_COUNT_LOG_THRESHOLD = BASE + "deltaCountLogThreshold";

        /**
         * The number of microseconds to delay the processing of each subscribe message. This reduces image
         * flooding when a {@link ProxyContext} reconnects to a bounced {@link Context}. <br> E.g.
         * <code>-DdataFission.subscribeDelayMicros=100</code>
         */
        String SUBSCRIBE_DELAY_MICROS = BASE + "subscribeDelayMicros";

        /**
         * The batch size to break a mass subscribe into smaller parts for processing. This helps to reduce
         * image flooding when a {@link ProxyContext} reconnects to a bounced {@link Context}. <br> E.g.
         * <code>-DdataFission.subscribeBatchSize=50</code>
         */
        ...
        /**
         * The name of the system property to define the period, in milliseconds, for a {@link Publisher} to
         * publish updates to the {@link ISystemRecordNames#CONTEXT_CONNECTIONS} record. <br> E.g.
         * <code>-DdataFission.connectionsRecordPublishPeriodMillis=30000</code>
         */
        String CONNECTIONS_RECORD_PUBLISH_PERIOD_MILLIS = BASE + "connectionsRecordPublishPeriodMillis";

        /**
         * The maximum size for the rx frame handling tasks pool in a {@link ProxyContext}.<br> E.g.
         * <code>-DdataFission.proxyRxFrameHandlerPoolMaxSize=1000</code>
         */
        String PROXY_RX_FRAME_HANDLER_POOL_MAX_SIZE = BASE + "proxyRxFrameHandlerPoolMaxSize";

        /**
         * Whether thread deadlock checking and thread dumps are enabled. <b>ENABLING THIS IS AN EXPENSIVE
         * OPERATION.</b> <br> E.g. <code>-DdataFission.enableThreadDeadlockCheck=false</code>
         */
        String ENABLE_THREAD_DEADLOCK_CHECK = BASE + "enableThreadDeadlockCheck";

        /**
         * The name of the system property to define the period, in milliseconds, for thread deadlock checks
         * and thread dumps. Only relevant if {@link #ENABLE_THREAD_DEADLOCK_CHECK} is true.<br> E.g.
         * <code>-DdataFission.threadDeadlockCheckPeriodMillis=300000</code>
         *
        ...
        /**
         * The name of the system property to define if queue statistics logging is enabled. <br> E.g.
         * <code>-DdataFission.enableQStatsLogging=false</code>
         */
        String ENABLE_Q_STATS_LOGGING = BASE + "enableQStatsLogging";

        /**
         * The name of the system property to define the symmetric transformation. <br> E.g.
         * <code>-DdataFission.encryptedSessionTransformation=AES/ECB/PKCS5Padding</code>
         */
        String ENCRYPTED_SESSION_TRANSFORMATION = BASE + "encryptedSessionTransformation";

        /**
         * The name of the system property to define the rpc names (comma separated) to exclude from logging.
    ...
    public interface Values
    {
        ...
        Long RPC_EXECUTION_START_TIMEOUT_MILLIS =
                SystemUtils.getPropertyAsLong(Names.RPC_EXECUTION_START_TIMEOUT_MILLIS, 5000);
        ...
        Long RPC_EXECUTION_DURATION_TIMEOUT_MILLIS =
                SystemUtils.getPropertyAsLong(Names.RPC_EXECUTION_DURATION_TIMEOUT_MILLIS, 5000);

        /**
         * The default period in milliseconds that a {@link ProxyContext} waits before reconnecting to a
         * {@link Context} after losing the connection.
         * <p>
         * Default is: 1000
         *
        ...
        int PROXY_CONTEXT_RECONNECT_PERIOD_MILLIS =
                SystemUtils.getPropertyAsInt(Names.PROXY_CONTEXT_RECONNECT_PERIOD_MILLIS, 1000);
        ...
        int PUBLISHER_MAXIMUM_CHANGES_PER_MESSAGE =
                SystemUtils.getPropertyAsInt(Names.PUBLISHER_MAXIMUM_CHANGES_PER_MESSAGE, 20);
         ...
         */
        int STATS_LOGGING_PERIOD_SECS = SystemUtils.getPropertyAsInt(Names.STATS_LOGGING_PERIOD_SECS, 30);
        /**
         ...
         */
        int MAX_MAP_FIELDS_TO_PRINT = SystemUtils.getPropertyAsInt(Names.MAX_MAP_FIELDS_TO_PRINT, 30);
        /**
         ...
         */
        int LONG_VALUE_POOL_SIZE = SystemUtils.getPropertyAsInt(Names.LONG_VALUE_POOL_SIZE, 2048);
         ...
         */
        int TEXT_VALUE_POOL_SIZE = SystemUtils.getPropertyAsInt(Names.TEXT_VALUE_POOL_SIZE, 0);

        /**
         * The text length limit to be eligible for the value to be held in the {@link TextValue} pool.
         * <p>
         * Default is 5.
         *
        ...
        int SYSTEM_RECORD_COALESCE_WINDOW_MILLIS =
                SystemUtils.getPropertyAsInt(Names.SYSTEM_RECORD_COALESCE_WINDOW_MILLIS, 250);
         ...
         */
        int DELTA_COUNT_LOG_THRESHOLD = SystemUtils.getPropertyAsInt(Names.DELTA_COUNT_LOG_THRESHOLD, 6);

        /**
         * The delay, in micro seconds, between handling subsequent subscribe messages during resyncing (there
         * can be 1000s of subscriptions in a resync).
         * <p>
         * Default is 0 (no delay).
         *
         * @see Names#SUBSCRIBE_DELAY_MICROS
         */
        int SUBSCRIBE_DELAY_MICROS = SystemUtils.getPropertyAsInt(Names.SUBSCRIBE_DELAY_MICROS, 0);
        ...
        long CONNECTIONS_RECORD_PUBLISH_PERIOD_MILLIS =
                SystemUtils.getPropertyAsLong(Names.CONNECTIONS_RECORD_PUBLISH_PERIOD_MILLIS, 30_000);
        ...
        int PROXY_RX_FRAME_HANDLER_POOL_MAX_SIZE =
                SystemUtils.getPropertyAsInt(Names.PROXY_RX_FRAME_HANDLER_POOL_MAX_SIZE, 1000);
        ...
        int THREAD_DEADLOCK_CHECK_PERIOD_MILLIS =
                SystemUtils.getPropertyAsInt(Names.THREAD_DEADLOCK_CHECK_PERIOD_MILLIS, 300_000);
