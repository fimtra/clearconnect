...
public abstract class Log {
	...
	private static String getLogMessage(Object source, CharSequence... messages) {
		...
		sb.append(fastDateFormat.yyyyMMddHHmmssSSS(System.currentTimeMillis())).append(TAB).append(Thread.currentThread().getName())
				.append(TAB).append(source instanceof Class ? ((Class<?>) source).getName() : source.getClass().getName()).append(":")
				.append(System.identityHashCode(source)).append(TAB);
		for (int i = 0; i < messages.length; i++) {
	...
	private static String getLogMessage(Object source, String message1, String message2, String message3, String message4) {
		StringBuilder sb = new StringBuilder(256);
		sb.append(fastDateFormat.yyyyMMddHHmmssSSS(System.currentTimeMillis())).append(TAB).append(Thread.currentThread().getName())
				.append(TAB).append(source instanceof Class ? ((Class<?>) source).getName() : source.getClass().getName()).append(":")
				.append(System.identityHashCode(source)).append(TAB).append(message1).append(message2).append(message3).append(message4);
		return sb.toString();
	}
	...
	private static String getLogMessage(Object source, String message1, String message2, String message3) {
		...
		sb.append(fastDateFormat.yyyyMMddHHmmssSSS(System.currentTimeMillis())).append(TAB).append(Thread.currentThread().getName())
				.append(TAB).append(source instanceof Class ? ((Class<?>) source).getName() : source.getClass().getName()).append(":")
				.append(System.identityHashCode(source)).append(TAB).append(message1).append(message2).append(message3);
		return sb.toString();
	}
	...
	private static String getLogMessage(Object source, String message1, String message2) {
		...
		sb.append(fastDateFormat.yyyyMMddHHmmssSSS(System.currentTimeMillis())).append(TAB).append(Thread.currentThread().getName())
				.append(TAB).append(source instanceof Class ? ((Class<?>) source).getName() : source.getClass().getName()).append(":")
				.append(System.identityHashCode(source)).append(TAB).append(message1).append(message2);
		return sb.toString();
	}
	...
	private static String getLogMessage(Object source, String message) {
		...
		sb.append(fastDateFormat.yyyyMMddHHmmssSSS(System.currentTimeMillis())).append(TAB).append(Thread.currentThread().getName())
				.append(TAB).append(source instanceof Class ? ((Class<?>) source).getName() : source.getClass().getName()).append(":")
				.append(System.identityHashCode(source)).append(TAB).append(message);
		return sb.toString();
	}
	...
	public static final void banner(Object source, String message) {
		...
		Log.log(source, SystemUtils.lineSeparator(), surround, SystemUtils.lineSeparator(), message, SystemUtils.lineSeparator(), surround);
	}
