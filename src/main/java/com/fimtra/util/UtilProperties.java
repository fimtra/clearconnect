...
public abstract class UtilProperties
{
    ...
    public interface Names
    {
        ...
        /**
         * The system property key that defines the log directory.<br> E.g. <code>-Dutil.logDir=/path/to/log/directory</code>
         */
        String SYSTEM_PROPERTY_LOG_DIR = BASE + "logDir";

        /**
         * The system property key that defines the log archive directory.<br> E.g.
         * <code>-Dutil.archiveDir=/path/to/log/archive/directory</code>
         */
        ...
        /**
         * The system property name to define if the {@link LowGcLinkedList} should be used by {@link
         * CollectionUtils#newDeque()}. <br> E.g. <code>-Dutil.useLowGcLinkedList=true</code>
         */
        String USE_LOW_GC_LINKEDLIST = BASE + "useLowGcLinkedList";

        /**
         * The system property name that defines the size of the internal spare nodes pool of the {@link
         * LowGcLinkedList}.<br> E.g. <code>-Dutil.logGcLinkedListInternalSparePoolSize=50</code>
         *
        ...
        /**
         * The system property name to define if the thread dumps use the same file or a rolling file.<br>
         * E.g. <code>-Dutil.useRollingThreaddumpFile=true</code>
         */
        String USE_ROLLING_THREADDUMP_FILE = BASE + "useRollingThreaddumpFile";

        /**
         * The system property name that defines the number of minutes for log files to be archived. A number
         * smaller than 1 will result in no archiving taking place.<br> E.g. <code>-Dutil.archiveLogsOlderThanMinutes=1440</code>
         */
        String ARCHIVE_LOGS_OLDER_THAN_MINUTES = BASE + "archiveLogsOlderThanMinutes";

        /**
         * The system property name that defines the number of minutes for archive log files to be deleted. A
         * number smaller than 1 will result in no purging taking place.<br> E.g.
         * <code>-Dutil.purgeArchiveLogsOlderThanMinutes=14400</code>
         */
        String PURGE_ARCHIVE_LOGS_OLDER_THAN_MINUTES = BASE + "purgeArchiveLogsOlderThanMinutes";

        /**
         * The system property name that defines the period of object pool logging in minutes.<br> E.g.
         * <code>-Dutil.objectPoolLogPeriodMins=10</code>
         */
        String OBJECT_POOL_SIZE_LOG_PERIOD_MINS = BASE + "objectPoolLogPeriodMins";

        /**
         * The system property name to define if rolled log files are compressed.<br> E.g.
         * <code>-Dutil.compressRolledLogs=true</code>
         */
        String COMPRESS_ROLLED_LOGS = BASE + "compressRolledLogs";

        /**
         * The system property name to define the maximum size of each internal pool of the {@link
         * ByteArrayPool}.<br> E.g. <code>-Dutil.byteArrayPoolSize=1024</code>
         */
        String BYTE_ARRAY_MAX_POOL_SIZE = BASE + "byteArrayMaxPoolSize";

        /**
         * The system property name to define the locking policy for the {@link NotifyingCache}.<br> E.g.
    ...
    public interface Values
    {
         ...
         */
        boolean LOG_TO_STDERR = SystemUtils.getProperty(Names.LOG_TO_STDERR, false);
        ...
        int LOW_GC_LINKEDLIST_INTERNAL_SPARE_POOL_SIZE =
                SystemUtils.getPropertyAsInt(Names.LOW_GC_LINKEDLIST_INTERNAL_SPARE_POOL_SIZE, 50);
         ...
         */
        boolean USE_LOW_GC_LINKEDLIST = SystemUtils.getProperty(Names.USE_LOW_GC_LINKEDLIST, true);
        ...
        boolean USE_ROLLING_THREADDUMP_FILE =
                SystemUtils.getProperty(Names.USE_ROLLING_THREADDUMP_FILE, false);

        /**
         * When logging initialises it will archive all files in the {@link Values#LOG_DIR} that are older
         * than this many minutes to an archive sub-directory. Default is <code>1</code>
         */
        int ARCHIVE_LOGS_OLDER_THAN_MINUTES =
                SystemUtils.getPropertyAsInt(Names.ARCHIVE_LOGS_OLDER_THAN_MINUTES, 1);

        /**
         * When logging initialises it will delete archive logs that are older than this many minutes. Default
         * is <code>20160</code> (14 days)
         */
        int PURGE_ARCHIVE_LOGS_OLDER_THAN_MINUTES =
                SystemUtils.getPropertyAsInt(Names.PURGE_ARCHIVE_LOGS_OLDER_THAN_MINUTES,
                        (int) TimeUnit.MINUTES.convert(14, TimeUnit.DAYS));
        ...
        int OBJECT_POOL_SIZE_LOG_PERIOD_MINS =
                SystemUtils.getPropertyAsInt(Names.OBJECT_POOL_SIZE_LOG_PERIOD_MINS, 30);
